	...
	<div class="card">
		<div class="card-body">
			<button class="btn btn-primary" type="button"
				style="margin-bottom: 10px;">${category}</button>
			...
			<div class="form-group">
				<div style="float: left">
					<c:if test="${userInfo.mem_state==1}">
						<button class="btn btn-secondary" type="button" onclick="javascript:modifyArticle('${bcode}', '${pg}', '${key}', '${word}','${article.seq}')">
							<i class="fa fa-pencil-square-o" aria-hidden="true" ></i> 수정
						</button>
						<button class="btn btn-secondary" type="button" onclick="javascript:deleteArticle('${bcode}', '${pg}', '${key}', '${word}','${article.seq}')">
			...
			<div style="margin-top: 50px;">
				<span class="text-danger"> <i class="fa fa-commenting-o"
					aria-hidden="true"></i> 댓글목록(댓글개수)
				</span>
			</div>

			<div style="margin-top: 25px; font-size: 13px;">
				<div class="jumbotron"
					style="padding: 16px 20px; background-color: #F6F6F6;">
					<span style="padding-right: 10px;"><b>댓글작성자 아이디</b></span> <span
						class="badge badge-primary"><i class="fa fa-reply"
						aria-hidden="true"></i> 답글</span> <span style="float: right;"><i
						class="fa fa-clock-o" aria-hidden="true"></i> 댓글 작성 날짜</span>
			...
			<div class="form-group">
				...
				<span><button class="btn btn-primary" type="button"
						style="margin-bottom: 10px; float: right; margin-top: 10px;">댓글
						등록</button></span>
			</div>
